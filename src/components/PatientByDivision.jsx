...
export const PatientByDivision = () => {
  return (
    <div className="w-full lg:w-[28%] bg-white rounded-lg p-4 lg:p-10  shadow-gray-300 shadow-sm h-[15rem]">
      <p className="font-bold flex items-center gap-3 justify-between mb-6">
